...
## [index.d.ts](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/babel__register/index.d.ts)
````ts
...
# Credits
These definitions were written by [Paul Sanchez](https://github.com/basicdays).
